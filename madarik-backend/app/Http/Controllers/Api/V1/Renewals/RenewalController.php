...
namespace App\Http\Controllers\Api\V1\Renewals;
...
class RenewalController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->json(Renewal::create($data), 201);
    }

    public function show(Request $request, int $id): JsonResponse
    {
        $record = Renewal::where('tenant_id', $request->user()->tenant_id)->findOrFail($id);

...
// Temporary route to sync clients
Route::get('v1/sync-clients', function () {
    ...
    return response()->json(['message' => "Synced {$count} clients successfully."]);
});
// Public: File Serving
...
Route::prefix('v1')->middleware(['auth:sanctum'])->group(function () {
    ...
    // Roles & Permissions
    Route::apiResource('roles', \App\Http\Controllers\Api\V1\Team\RoleController::class)->except(['show']);
    Route::get('permissions', [\App\Http\Controllers\Api\V1\Team\RoleController::class, 'permissions']);
